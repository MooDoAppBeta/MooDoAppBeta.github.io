var CacheName = 'moodo-cache-1523347786199',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/app/',
                '/app/index-1523347786199.html',
                '/js/vendor-1523347786199.js',
                '/js/delayedUI-1523347786199.js',
                '/js/dimport-1523347786199.js',
                '/js/main-min-1523347786199.js',
                '/js/preload-min-1523347786199.js',
                '/css/app-min-1523347786199.css',
                '/css/fonts/fonticons-1523347786199.woff',
                '/css/fonts/fonticons-1523347786199.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1523347786199.html');
        }
