var CacheName = 'moodo-cache-1542464415971',
...
self.addEventListener('install', function (e)
{
    ...
    e.waitUntil(
        caches.open(CacheName).then(function (cache)
        {
            return cache.addAll([
                '/newmobile/',
                '/newmobile/index-1542464415971.html',
                '/newmobile/js/vendor-1542464415971.js',
                '/newmobile/js/delayedUI-1542464415971.js',
                '/newmobile/js/app-1542464415971.js',
                '/newmobile/js/preload-1542464415971.js',
                '/newmobile/js/preload.worker-1542464415971.js',
                '/newmobile/css/app-min-1542464415971.css',
                '/newmobile/css/fonts/fonticons-1542464415971.woff',
                '/newmobile/css/fonts/fonticons-1542464415971.ttf'
            ]);
...
self.addEventListener('fetch', function (event)
{
    ...
    if (urlObj.origin === location.origin && urlObj.href.indexOf(urlObj.origin + pathname) === 0)
    {
        ...
        {
            url = url.replace(pathname, pathname + 'index-1542464415971.html');
        }
